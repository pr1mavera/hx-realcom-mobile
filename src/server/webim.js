...
(function (webim) {
    ...
    Msg.Elem.Custom = function (data, desc, ext, isSync) {
        this.data = data; //数据
        this.desc = desc; //描述
        this.ext = ext; //扩展字段
        this.isSync = isSync; // 是否保存进漫游消息（默认为1：同步到 From_Account 在线终端和漫游上）
    };
    ...
    Msg.Elem.Custom.prototype.getSyncType = function () {
        return this.isSync;
    };
